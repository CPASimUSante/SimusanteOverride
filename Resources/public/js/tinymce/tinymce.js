...
(function () {
    ...
    tinymce.claroline.configuration = {
        ...
        'toolbar2': 'styleselect | undo redo | bullist numlist | outdent indent | ' +
    ...
    tinymce.claroline.initialization = function ()
    {
        $('textarea.claroline-tiny-mce:not(.tiny-mce-done)').each(function () {
            ...
            var toolbar1 = 'bold italic underline strikethrough emoticons | alignleft aligncenter alignright alignjustify | fullscreen displayAllButtons'
